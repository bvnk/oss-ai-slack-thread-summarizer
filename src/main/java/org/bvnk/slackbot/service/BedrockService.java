...
public class BedrockService {
    ...
    public String getResponse(String threadContext, String userQuestion) {
        try {
            ...
            // Add system prompt
            requestBody.put("system", "You are a helpful AI assistant analyzing a Slack conversation thread. " +
    ...
    /**
     * Format the AI response for Slack display
     * Handles code blocks, truncation, and Slack-specific formatting
     */
