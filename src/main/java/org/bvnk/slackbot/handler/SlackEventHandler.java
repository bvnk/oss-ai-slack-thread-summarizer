...
public class SlackEventHandler implements RequestHandler<Object, Object> {
    ...
    public Object handleRequest(Object input, Context context) {
        ...
        if (input instanceof Map) {
            ...
            if (inputMap.containsKey("httpMethod") && inputMap.containsKey("headers") && inputMap.containsKey("body")) {
                // Convert Map to APIGatewayProxyRequestEvent
                APIGatewayProxyRequestEvent request = objectMapper.convertValue(inputMap, APIGatewayProxyRequestEvent.class);
                return handleApiGatewayRequest(request, context);
            } else {
                // This is an async invocation - delegate to AsyncProcessorHandler
                logger.info("Handling async invocation");
    ...
    private APIGatewayProxyResponseEvent handleApiGatewayRequest(APIGatewayProxyRequestEvent request, Context context) {
